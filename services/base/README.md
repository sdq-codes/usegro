...
[![Go Report Card](https://goreportcard.com/badge/github.com/sdq-codes/usegro-api)](https://goreportcard.com/report/github.com/sdq-codes/usegro-api)
[![Go with Confidence](https://github.com/sdq-codes/usegro-api/actions/workflows/go_with_confidence.yml/badge.svg)](https://github.com/sdq-codes/usegro-api/actions/workflows/go_with_confidence.yml)
...
1. Clone the repo
   ```sh
   git clone https://github.com/sdq-codes/usegro-api.git
    ```
