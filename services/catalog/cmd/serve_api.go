...
import (
	...
	grpcserver "github.com/usegro/services/catalog/internal/grpc"
	"github.com/usegro/services/catalog/internal/interface/validation"
	"github.com/usegro/services/catalog/internal/logger"
	"github.com/usegro/services/catalog/internal/router"
	"github.com/usegro/services/catalog/pkg/amplitude"
)
...
var serveAPICmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		// Start gRPC server
		grpcPort := config.GetConfig().GrpcServer.Port
		go grpcserver.StartGRPCServer(grpcPort, database.PostgressInstance1, database.SingleRdb)
