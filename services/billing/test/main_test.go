...
import (
	...
	"github.com/usegro/services/billing/internal/db/pgx"
	"io"
	"net/http"
	"os"
	"testing"
	...
	"github.com/usegro/services/billing/internal/repository"
...
func setup() {
	...
	// Set up redis
	println("setup redis")
	database.InitRedisClient(config.GetConfig().Redis)
