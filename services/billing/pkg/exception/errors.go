...
var (
	...
	InvalidRequestBodyError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusInternalServerError,
		ERROR_TYPE_BAD_REQUEST,
		SUBCODE_INTERNAL_SERVER,
		"Internal server error",
	)
	InternalServerErrorError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusBadRequest,
		ERROR_TYPE_BAD_REQUEST,
		SUBCODE_INVALID_REQUEST_BODY,
		"invalid request body",
	)
	IncorrectUserNameAndPasswordRequestBodyError *ExceptionErrors = createFixedExceptionErrors(
	...
	// Invalid UUID
	InvalidUUIDError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_VALIDATION_FAILED,
		"Invalid UUID",
	)
	ResetPasswordTokenExpiredError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_USER_EMAIL_ALREADY_TAKEN,
		"Reset password token expired",
	)
	UserEmailNotFoundError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_USER_EMAIL_ALREADY_TAKEN,
	...
	BusinessNameAlreadyTakenError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_USER_EMAIL_ALREADY_TAKEN,
		"Business name already exists",
	)
	IncorrectEmailVerificationError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_USER_EMAIL_ALREADY_TAKEN,
		"Incorrect email verification code",
	)
	InvalidLoginCodeError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnauthorized,
		ERROR_TYPE_UNAUTHORIZED,
		SUBCODE_UNAUTHORIZED,
		"Invalid or expired login code",
	)
	TooManyRequestsError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusTooManyRequests,
		ERROR_TYPE_BAD_REQUEST,
		SUBCODE_BAD_REQUEST,
		"Too many requests, please try again later",
	)
	EmailVerificationError *ExceptionErrors = createFixedExceptionErrors(
		http.StatusUnprocessableEntity,
		ERROR_TYPE_VALIDATION_ERROR,
		SUBCODE_USER_EMAIL_ALREADY_TAKEN,
